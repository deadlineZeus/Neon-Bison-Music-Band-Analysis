...
## 🧾 Executive Summary
Neon Bison is a modern music band aiming to launch a global concert tour. This project identifies the most strategically sound and profitable cities to include in the tour, based on data from music sales, genre preferences, and customer behaviors. Through analysis of average customer revenue, genre affinity, and buyer loyalty, we curated a tiered list of cities that balance fan engagement with financial viability.

## 🎯 Business Objective
**Core Question:** *Which cities should Neon Bison target for their global tour to maximize profitability, fan engagement, and loyalty?*

The goal is to make an informed tour route that aligns the band's strengths—especially in Rock genre popularity—with cities demonstrating strong customer metrics.

## 📦 Data Overview
- **Customers:** ID, location (city, country), premium status  
- **Purchases:** invoice totals, genre bought, repeat purchases  
- **Genres:** mapping of customer taste per region  

Data was preprocessed in Python and SQL. Genre percentages and customer-level metrics were computed.

## 🧠 Key Metrics and Justifications

### 1. Avg. Revenue per Customer
- Top cities: São Paulo ($42), New York ($37), Toronto ($34)  
- Indicates potential ticket pricing and merchandise sales

### 2. Rock Genre Popularity (%)
- Top cities: São Paulo (68%), Prague (62%), Edmonton (61%)  
- Shows affinity with the band’s style and genre alignment

### 3. Repeat Buyers Count
- Top cities: São Paulo (35), New York (29), Toronto (24)  
- Suggests loyalty and higher ticket conversion

## 📍 City Tiering & Tour Plan

### Tier 1 – Must Include
- **São Paulo**, **New York**, **Toronto**, **Brasília**

### Tier 2 – Consider Including
- **London**, **Berlin**, **Prague**

### Tier 3 – Emerging Markets
- **Melbourne**, **Brisbane**, **Edmonton**

> 📌 All cities selected based on performance in at least 2 of the 3 core metrics.

## 🗺️ Final Tour Route Proposal
A global tour map visual was generated to connect selected cities in a logical sequence, balancing travel efficiency and geographic coverage. *(Visuals in `/visuals` folder)*

## 🛠️ Tools & Technologies Used
- **Languages:** Python, SQL  
- **Libraries:** Pandas, NumPy, Matplotlib, Seaborn  
- **Visualization:** Power BI, React (for dashboard)

## 💡 Business Recommendations
- Launch promotional campaign in São Paulo and Toronto.  
- Offer loyalty perks in Prague and Edmonton.  
- Utilize local genre trends for merchandise and media targeting.
